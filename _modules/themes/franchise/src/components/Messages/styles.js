...
var HeaderName = _styledComponents.default.p(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n  font-size: 1.1em;\n  margin-block-end: 0.1em;\n  margin-block-start: 0.1em;\n\n"])));

exports.HeaderName = HeaderName;

var Status = _styledComponents.default.p(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n  margin-block-start: 0.1em;\n  margin-block-end: 0.1em;\n  font-size: 0.7em;\n"])));

exports.Status = Status;

var Image = _styledComponents.default.div(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n  width: 36px;\n  height: 36px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  border-radius: 7.6px;\n  padding: 5px;\n  box-sizing: border-box;\n  overflow: hidden;\n  box-shadow: 0px 1px 4px rgba(0, 0, 0, 0.1);\n\n  img {\n    width: 100%;\n    height: auto;\n    border-radius: 50%;\n    object-fit: cover;\n    border: 1px solid #F5F5F5;\n  }\n\n  img[name]{\n    border: 1px solid #D81212;\n    border-radius: 50%;\n  }\n\n  svg {\n    width: 36px;\n    height: 36px;\n  }\n"])));

exports.Image = Image;

var HeaderOnline = _styledComponents.default.div(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  height: 36px;\n  display: flex;\n  align-items: flex-start;\n  justify-content: center;\n  text-align: left;\n  margin-left: 10px;\n\n  ", "\n  h1,\n  span {\n    margin: 0px;\n  }\n\n  h1 {\n    font-weight: 600;\n    font-size: 14px;\n  }\n\n  span {\n    font-size: 10px;\n    font-weight: 300;\n  }\n"])), function (props) {
  var _props$theme3;
...
var MessageConsole = _styledComponents.default.div(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  width: 100%;\n  display: inline-flex;\n  justify-content: center;\n  font-size: 0.8em;\n  border-radius: 60px;\n"])));

exports.MessageConsole = MessageConsole;

var MessageBusiness = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-wrap: wrap;\n  font-size: 0.8em;\n"])));

exports.MessageBusiness = MessageBusiness;

var MessageCustomer = _styledComponents.default.div(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  align-items: flex-end;\n  flex-wrap: wrap;\n  font-size: 0.8em;\n"])));

exports.MessageCustomer = MessageCustomer;

var BubbleConsole = _styledComponents.default.div(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  border-radius: 5px;\n  padding: 5px 15px;\n  max-width: 40%;\n  margin-bottom: 15px;\n  background: #EFEFEF;\n  text-align: center;\n  height: auto;\n  overflow: hidden;\n  overflow-wrap: break-word;\n  @media (min-width: 1024px){\n    max-width: 30%\n  }\n"])));

exports.BubbleConsole = BubbleConsole;

var BubbleBusines = _styledComponents.default.div(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  border-radius: 7.6px 7.6px 7.6px 0px;\n  padding: 10px 25px 10px 25px;\n  max-width: 60%;\n  min-width: 80px;\n  margin-bottom: 10px;\n  background: #EFEFEF;\n  overflow: hidden;\n  overflow-wrap: break-word;\n  &[name=image]{\n    border-radius: 7.6px 7.6px 7.6px 0px;\n    width: 100%;\n  }\n\n  ", "\n\n  @media (min-width: 480px) {\n    border-radius: 7.6px 7.6px 7.6px 0px;\n\n    ", "\n  }\n\n  @media (min-width: 1024px){\n    max-width: 40%;\n  }\n"])), function (props) {
  var _props$theme4;
...
var BubbleCustomer = _styledComponents.default.div(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  border-radius: 7.6px 7.6px 0px 7.6px;\n  padding: 10px 25px 10px 25px;\n  max-width: 60%;\n  min-width: 80px;\n  height: auto;\n  margin-bottom: 10px;\n  background: ", ";\n  color: white;\n  overflow-wrap: break-word;\n  overflow: hidden;\n\n  p:last-child {\n    left: 10px;\n  }\n\n  &[name=image]{\n    border-radius: 7.6px 7.6px 0px 7.6px;\n    width: 100%;\n  }\n\n  ", "\n  \n  @media (min-width: 480px){\n    border-radius: 7.6px 7.6px 0px 7.6px;\n\n    ", "\n  }\n\n  @media (min-width: 1024px){\n    max-width: 40%\n  }\n\n"])), function (props) {
  var _props$theme6;
...
var SkeletonBubbleCustomer = _styledComponents.default.div(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n  span{\n    border-radius: 7.6px 7.6px 0px 7.6px;\n    ", "\n  }\n"])), function (props) {
  var _props$theme9;
...
var SkeletonBubbleBusiness = _styledComponents.default.div(_templateObject24 || (_templateObject24 = _taggedTemplateLiteral(["\n  span{\n    border-radius: 7.6px 7.6px 7.6px 0px;\n    ", "\n  }\n"])), function (props) {
  var _props$theme10;
...
var ChatImage = _styledComponents.default.div(_templateObject26 || (_templateObject26 = _taggedTemplateLiteral(["\n  width: 100%;\n  height: auto;\n  margin-bottom: 10px;\n  img{\n    width: 100%;\n    height: auto;\n    max-height: 300px;\n    aspect-ratio: attr(width) / attr(height);\n    vertical-align: middle;\n    object-fit: contain;\n    cursor: pointer;\n  }\n"])));

exports.ChatImage = ChatImage;

var PartnerName = _styledComponents.default.p(_templateObject27 || (_templateObject27 = _taggedTemplateLiteral(["\n  margin-block-start: 0;\n  margin-block-end: 0.6em;\n  font-size: 1.1em;\n"])));

exports.PartnerName = PartnerName;

var MyName = _styledComponents.default.p(_templateObject28 || (_templateObject28 = _taggedTemplateLiteral(["\n    margin-block-start: 0;\n    margin-block-end: 0.6em;\n    font-size: 1.1em;\n    text-align: right;\n\n    ", "\n"])), function (props) {
  var _props$theme11;
...
var TimeofSent = _styledComponents.default.p(_templateObject30 || (_templateObject30 = _taggedTemplateLiteral(["\n  position: relative;\n  text-align: right;\n  font-size: 0.8em;\n  margin-block-start: 0.2em;\n  margin-block-end: initial;\n\n  ", "\n"])), function (props) {
  var _props$theme12;
...
var TimeofSentByAdmin = _styledComponents.default.p(_templateObject32 || (_templateObject32 = _taggedTemplateLiteral(["\n    position: relative;\n  text-align: left;\n  font-size: 0.8em;\n  margin-block-start: 0.2em;\n  margin-block-end: initial;\n\n  ", "\n"])), function (props) {
  var _props$theme13;
...
var Send = _styledComponents.default.form(_templateObject35 || (_templateObject35 = _taggedTemplateLiteral(["\n  align-items: center;\n  display: flex;\n  margin-top: 3px;\n  height: auto;\n  width: 100%;\n  input {\n    padding-top: 13px;\n    padding-bottom: 13px;\n    width: 100%;\n    background: #F8F9FA;\n    border-radius: 7.6px;\n    border: none;\n    font-size: 12px;\n    box-sizing: border-box;\n    ", "\n  }\n"])), function (props) {
  var _props$theme14;
...
var SendImage = _styledComponents.default.label(_templateObject38 || (_templateObject38 = _taggedTemplateLiteral(["\n  width: 15px;\n  height: 15px;\n  position: ", ";\n  opacity: ", ";\n  right: 16px;\n  top: 11px;\n\n  ", "\n\n  input {\n    display: none;\n  }\n\n\n\n  svg {\n    color: #CFD0D0;\n    width: 15px;\n    height: 15px;\n    cursor: pointer\n  }\n"])), function (props) {
...
var WrapperSendMessageButton = _styledComponents.default.div(_templateObject43 || (_templateObject43 = _taggedTemplateLiteral(["\n  white-space: nowrap;\n  margin-left: 20px;\n  ", "\n\n  button{\n    padding-top: 6px;\n    padding-bottom: 6px;\n      svg {\n        display: inline;\n        width: 20px;\n        height: 20px; \n        vertical-align: middle;\n        color: white;\n        ", "\n    }\n\n    span {\n      display: none;\n    }\n\n    &:disabled {\n      opacity: 0.5;\n      cursor: not-allowed;\n    }\n  }\n\n  @media (min-width: 480px){\n    button{\n      svg {\n        display: none;\n      }\n      span {\n        display: inline;\n      }\n    }\n  }\n"])), function (props) {
  var _props$theme17;
...
var ImageContainer = _styledComponents.default.div(_templateObject46 || (_templateObject46 = _taggedTemplateLiteral([" \n  max-height: 500px;\n  img{\n    width: 100%;\n    height: auto;\n    aspect-ratio: attr(width) / attr(height);\n    border-bottom-left-radius: 10px;\n    border-bottom-right-radius: 10px;\n  }\n"])));

exports.ImageContainer = ImageContainer;

var ModalIcon = _styledComponents.default.span(_templateObject47 || (_templateObject47 = _taggedTemplateLiteral(["\n  display: flex;\n  position: absolute;\n  width: 30px;\n  height: 30px;\n  font-size: 30px;\n  cursor: pointer;\n  color: white;\n  border-radius: 50%;\n  right: 5px;\n  top: 5px;\n  z-index: 1;\n  background: rgba(0,0,0,0.3);\n  ", "\n  @media (min-width: 578px){\n    right: 10px;\n    ", "\n  }\n  @media (min-width: 769px){\n    right: 5px;\n    ", "\n  }\n"])), function (props) {
  var _props$theme19;
...
var MessagesLayoutWrapper = _styledComponents.default.div(_templateObject51 || (_templateObject51 = _taggedTemplateLiteral(["\n  display: flex;\n  border-left: 1px solid #DEE2E6;\n  border-right: 1px solid #DEE2E6;\n  position: relative;\n  flex-direction: column;\n\n  @media (min-width: 769px) {\n    flex-direction: row;\n  }\n"])));

exports.MessagesLayoutWrapper = MessagesLayoutWrapper;

var MessagesLeftLayout = _styledComponents.default.div(_templateObject52 || (_templateObject52 = _taggedTemplateLiteral(["\n  width: 100%;\n  border-right: 1px solid #DEE2E6;\n  min-width: 250px;\n\n  ", "\n\n  @media (min-width: 769px) {\n    width: 30%;\n  }\n"])), function (props) {
  var _props$theme22;
...
var MessagesRightLayout = _styledComponents.default.div(_templateObject54 || (_templateObject54 = _taggedTemplateLiteral(["\n  width: 100%;\n  border-top: 1px solid #DEE2E6;\n  margin-top: 30px;\n\n  @media (min-width: 769px) {\n    width: 70%;\n    border: none;\n    margin-top: 0;\n  }\n"])));

exports.MessagesRightLayout = MessagesRightLayout;

var MessagesTitle = _styledComponents.default.div(_templateObject55 || (_templateObject55 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  border-bottom: 1px solid #DEE2E6;\n  padding: 15px 20px;\n  height: 70px;\n  box-sizing: border-box;\n\n  h1 {\n    font-weight: 600;\n    font-size: 20px;\n    color: ", ";\n    margin: 0;\n  }\n"])), function (props) {
  var _props$theme23;
...
var CustomerList = _styledComponents.default.div(_templateObject56 || (_templateObject56 = _taggedTemplateLiteral(["\n  > div {\n    border: none;\n  }\n"])));

exports.CustomerList = CustomerList;

var MessagesClose = _styledComponents.default.div(_templateObject57 || (_templateObject57 = _taggedTemplateLiteral(["\n  position: absolute;\n  top: 10px;\n  right: 10px;\n  ", "\n  cursor: pointer;\n\n  svg {\n    font-size: 24px;\n  }\n"])), function (props) {
  var _props$theme24;
...
var InputWrapper = _styledComponents.default.div(_templateObject59 || (_templateObject59 = _taggedTemplateLiteral(["\n  width: 60%;\n  flex: 1;\n  position: relative;\n"])));

exports.InputWrapper = InputWrapper;

var MessageContentWrapper = _styledComponents.default.div(_templateObject60 || (_templateObject60 = _taggedTemplateLiteral([""])));

exports.MessageContentWrapper = MessageContentWrapper;

var MessageCreatedDate = _styledComponents.default.div(_templateObject61 || (_templateObject61 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  margin-bottom: 12px;\n\n  span {\n    font-size: 12px;\n    color: ", "\n  }\n"])), function (props) {
  var _props$theme25;
